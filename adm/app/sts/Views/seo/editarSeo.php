    ...
    <div class="list-group-item">
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">                   
                    <label>
                        <span tabindex="0" data-toggle="tooltip" data-placement="top" data-html="true" title="Nome de usuário no twiter. Ex: @angelo.caixeta">
                            <i class="fas fa-question-circle"></i>
                        </span> 
                        <span class="text-danger">*</span> Nome do Twiter
                    </label>
                    <input name="twitter_site" type="text" class="form-control" placeholder="Nome de usuário no twiter. Ex: @angelo.caixeta" value="<?php
